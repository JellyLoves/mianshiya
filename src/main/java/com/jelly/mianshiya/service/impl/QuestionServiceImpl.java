...
import com.jelly.mianshiya.mapper.QuestionMapper;
    ...
    public Page<Question> listQuestionByPage(QuestionQueryRequest questionQueryRequest) {
        ...
        if (questionBankId != null) {
            ...
            if (CollUtil.isNotEmpty(questionList)) {
                queryWrapper.in("id", questionList.stream().map(QuestionBankQuestion::getQuestionId).collect(Collectors.toSet()));
            }
        }
